...
float distancia_social = 1.5 * min_distancia;  //distancia social para no contagiarse
float p_transmision = 0.5; // probabilidad de que un enfermo contagie a un sano
...
float p_mascarilla = 0.0; // probabilidad de que un individuo use mascarilla
float p_en_casa = 0.0; // probabilidad de que un individuo se quede en casa
boolean colision = false; // establece si habrán colisiones o no
